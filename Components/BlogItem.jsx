...
//   return (
//     <div className='max-w-[330px] sm:max-w-[300px] bg-white border border-black hover:shadow-[-7px_7px_0px_#000000] transform transition-transform duration-300 hover:scale-105'>
//         <Link href={`/blogs/${id}`}>
//         <Image src={image} alt='img' width={400} height={400} className='border-b border-black'/>
//         </Link>
